...
public class FileView extends Application implements EventHandler<Event>{
    ...
    private MenuItem open,save, close, exit, font, color;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        save.addEventHandler(EventType.ROOT, this);
        save.setAccelerator(
        ...
        file = new Menu("File", null, open,save, close, exit);
...
//            fileChooser.showSaveDialog(fileChooser);
            try {
                FileWriter fileWriter = new FileWriter(fileChooser.getInitialDirectory(), true);
